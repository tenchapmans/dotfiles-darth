...
myManageHook = composeAll . concat $
    ...
    myCFloats = ["Arandr", "Arcolinux-calamares-tool.py", "Archlinux-tweak-tool.py", "Arcolinux-welcome-app.py", "Galculator", "feh", "mpv", "Xfce4-terminal", "zoom ", "1password"]
    myTFloats = ["Downloads", "Save As..."]
    myRFloats = []
    myIgnores = ["desktop_window"]
    my1Shifts = ["firefox", "brave-browser", "slack"]
    my2Shifts = ["kitty"]
    my3Shifts = ["Thunar"]
    my4Shifts = ["code-oss"]
    my5Shifts = ["zoom"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_g), windowPrompt def Bring allWindows )
  ...
  , ((modMask .|. shiftMask , xK_z ), spawn $ "zoom")
